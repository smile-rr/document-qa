...
from llm_core.document_reader import read_pdf, read_excel, split_documents, to_documents
from llm_core.llm import create_embeddings
from llm_core.llm_config import OPENAI_EMBEDDING
...
if __name__ == "__main__":
    ...
    db = VectorStore(embeddings=embeddings, dir="./faiss_db_3", documents=chunks)
